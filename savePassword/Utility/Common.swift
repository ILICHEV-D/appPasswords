...
extension Common {
    ...
    static var dictionaryOfTypes = ["Социальные сети": ["skype", "twitter", "reddit", "facebook", "snapchat", "instagram", "vk"],
                                    "Путешествия": ["skyscanner", "trivago", "booking", "tripadvisor"],
                                    "Игры, развлечения": ["epicgames", "ps", "netflix", "discord", "xbox", "blizzard", "spotify", "steam", "origin"]]
